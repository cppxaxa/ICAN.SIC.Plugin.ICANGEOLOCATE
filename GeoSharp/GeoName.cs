...
namespace GeoSharp
{
    ...
    public class GeoName : KDTree.IKDComparator<GeoName>
    {
        ...
        public int DbLineNumber;

        public GeoName(string GeoEntry, int dbLineNumber = 0)
        {
            string[] Fields = GeoEntry.Split('\t');
            if (Fields.Length != (int)GeoFields.Count)
                throw new ArgumentException("Invalid GeoName Record, Count != " + ((int)GeoFields.Count));
            ...
            this.DbLineNumber = dbLineNumber;
        }
